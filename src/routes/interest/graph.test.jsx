...
describe('PaymentsGraph', () => {
  ...
  it('should pass remaining balance dataset', () => {
    ...
    expect(chartData.datasets[0].data).toEqual([9875.5, 9750.25]);
  });
  ...
  it('should have different colors for each dataset', () => {
    ...
    expect(chartData.datasets[0].borderColor).not.toBe(
      chartData.datasets[1].borderColor
    );
    expect(chartData.datasets[0].backgroundColor).not.toBe(
