...
export const WeightedInterest = () => {
    ...
    return (
        <div className="interest-weight-calculation">
            <p className="pb-4">
                Quick math problem: you owe $10k at 5.25% and $20k at 6.25%.
                What percent are you paying on the $30k? That's what this form
                will tell you 😉
            </p>
            ...
            {!!totalAmount && (
                <h3 className="is-size-3">
                    You owe ${totalAmount} at an interest rate of{' '}
                    {weightedInterest}%.
                </h3>
            )}
        </div>
